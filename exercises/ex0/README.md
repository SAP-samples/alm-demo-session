...
During this Teched exercise, you will instrument a Nodejs application and deploy it into an SAP BTP subaccount. You will then activate the monitoring for this NodeJs application in a shared SAP Cloud ALM. 
